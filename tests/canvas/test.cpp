...
int main(int argc, char* argv)
{
	...
	image_io::show_image(canvas2.image(), "RoseLine");
	...
	canvas.draw_line(line2di({ 0, 350 }, { 700, 350 })); // x axis
	canvas.draw_line(line2di({ 350, 0 }, { 350, 700 })); // y axis

	canvas2.draw_line(line2di({ 0, 350 }, { 700, 350 })); // x axis
	canvas2.draw_line(line2di({ 350, 0 }, { 350, 700 })); // y axis

	// x [-pi, pi] [50, 650]
	// y [-1, 1] [50, 650]
	const float PI = 3.1415926535897932384;

	vector<point2di> pts(700);
